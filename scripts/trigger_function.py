...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Helper script to trigger a backend function"
    )
    parser.add_argument(
        "function", help="function to be triggered", choices=["analyzer", "importer"]
    )
    parser.add_argument(
        "--env",
        help="environment to send the trigger",
